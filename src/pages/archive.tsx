...
export default function Archive() {
  ...
  return (
    <main className="flex items-center justify-center min-h-screen">
      <Head>
        <title>advay chandorkar — archive</title>
      ...
      <div
        className="min-h-screen min-h-[100dvh] w-full relative flex items-center justify-center px-3 sm:px-0"
        ...
        <div className="relative w-full max-w-[1100px]">
          ...
          <div className="flex flex-col items-center justify-center space-y-2">
            <div className="flex flex-col leading-relaxed text-primary text-center text-[14px] sm:text-base px-1" style={{ fontFamily }}>
              ...
              <p className="mt-1">
                to learn more about me, click the files - or view my resume <Link href="/resume.pdf">here</Link> or check out the resume <Link target="_self" href="/">here</Link> !
              </p>
              <div className="mt-2">
